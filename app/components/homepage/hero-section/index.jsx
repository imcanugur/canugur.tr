...
import { featuredSkills, hireable } from "@/utils/data/skills";
        ...
        <div className="order-1 lg:order-2 from-[#0d1224] border-[#1b2c68a0] relative rounded-lg border bg-gradient-to-r to-[#0a0d37]">
          ...
          <div className="overflow-hidden border-t-[2px] border-indigo-900 px-4 lg:px-8 py-4 lg:py-8">
            <code className="font-mono text-xs md:text-sm lg:text-base">
              ...
              {/* Hireable kısmı */}
              {Object.entries(hireable).map(([key, value], index) => (
                <div key={index}>
                  <span className="ml-4 lg:ml-8 mr-2 text-white">{key}:</span>
              ...
              {Object.keys(hireable).map((key, index) => (
                <div key={index}>
                  <span className="ml-12 lg:ml-24 text-cyan-400">this.</span>
                  <span className="mr-2 text-white">{key}</span>
                  {index < Object.keys(hireable).length - 1 && (
                    <span className="text-amber-300">&amp;&amp;</span>
                  )}
                </div>
              ))}

              {/* Skills length kontrolü */}
              <div>
                <span className="ml-12 lg:ml-24 text-cyan-400">this.</span>
